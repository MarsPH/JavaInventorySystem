    ...
    public static void main(String[] args) {
        ...
        do {
            try {
                ...
                //validates it here, so if constructor have problem with InputName, the user will notify now other than...
                //...later
                ...
                // try to construct Item, if no exception thrown, then...
                //...it means its good
                ItemToPut = new Item(InputName, InputValue);

                //adds the Item to the map, with the key of its name, so can be accessed with its name
